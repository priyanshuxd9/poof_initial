...
### Group Creation
-   **Simple Group Setup**: Easily start new groups with a name, description, an optional custom icon, and a mandatory self-destruct timer (from 1 to 31 days).
...
3.  **Set up Environment Variables**:
    Create a `.env` file in the root of the project and populate it with your Firebase credentials.
